...
// сначала с неотсортированной частью и продолжаем его до тех пор, пока индексы левой и
// правой сторон массива не пересекутся.

// ДОКАЗАТЕЛЬСТВО КОРРЕКТНОСТИ

// Чтобы определить, отсортирована ли уже левая или правая часть массива, достаточно
// сравнить крайний левый элемент с тем, что расположено посередине. Так как мы знаем,
// что массив уже отсортирован (и просто сдвинут индекс первого элемента), левая часть
// должна быть отсортирована, если крайний левый элемент меньше элемента посередине.
...
// Так как бинарный поиск реализован рекурсивно, пространственная сложность тоже является O(log(n)).
